...
// Used synchronize movement of A.I Objecys in ar world
public class AISynchronizationScript : MonoBehaviour, IPunObservable
{
    ...
    // called by photon view same as custom synchronization script on player
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        if (stream.IsWriting)
        {
            ...
            stream.SendNext(rb.position-Platform.transform.position);
        ...
        else
        {
            ...
            networkedPosition = (Vector3)stream.ReceiveNext()+ Platform.transform.position;
